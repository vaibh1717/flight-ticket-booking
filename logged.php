...
<body background="airplane.jpg">
	...
	<br>
	<br>
	<div class="mdl-shadow--16dp" style="background-color:black"><br>
    <div class="mdl-shadow--16dp" style="background-color:grey;color:white"><br>
                        ...
                        <div class="mdl-shadow--16dp" style="background-color:grey"><br>
...
<input style="background-color:grey;color:white"type="submit" value="Log Out" class="mdl-button mdl-js-button mdl-button--raised mdl-js-ripple-effect mdl-button--accent">
</form>
