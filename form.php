    ...
    <div class="mdl-layout mdl-js-layout mdl-layout--fixed-header">
        <header style= "color:black;background-color:#4F5356 " class="mdl-layout__header">
            <div class="mdl-layout__header-row">
                <!-- Title -->
                <span class="mdl-layout-title"style="color:white">Signup</span>
                <!-- Add spacer, to align navigation to the right -->
                <div class="mdl-layout-spacer"></div>
                <!-- Navigation. We hide it in small screens. -->
                <nav class="mdl-navigation mdl-layout--large-screen-only">
                    <a class="mdl-navigation__link" href="home.php"style="color:white">Home</a>
                    <a class="mdl-navigation__link" href="Aboutus.php"style="color:white">About</a>
...
<br><br>
                        <div class="demo-card-wide mdl-card mdl-shadow--16dp">
                            <b> <div class="mdl-shadow--16dp" style="background-color:#4F5356 ">
                        <br>
                        <div class="mdl-typography--title" style="color:white">Name</div>
                        <br><br>
                        </div>
                            <div class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label">
                                <input class="mdl-textfield__input" type="text" id="First-Name" name="First-Name">
                                <label class="mdl-textfield__label" for="First-Name"style="color:#606B71  ">First Name</label>
                            </div>
                            <div class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label">
                                <input class="mdl-textfield__input" type="text" id="Last-Name" name="Last-Name">
                                <label class="mdl-textfield__label" for="Last-Name"style="color:#606B71  ">Last Name</label>
                            </div>    
                                <br>
                                <div class="mdl-shadow--16dp" style="background-color:#4F5356 ">
                        <br>
                        <div class="mdl-typography--title" style="color:white"style="color:#606B71 ">Email Id</div>
                        <br><br>
                        </div>
                            <div class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label">
                                <input class="mdl-textfield__input" type="text" id="Email" name="Email">
                                <label class="mdl-textfield__label" for="Email"style="color:#606B71">Email Id</label>
                            </div>
                            <br>
                            
                                <div class="mdl-shadow--16dp" style="background-color:#4F5356 ">
                        <br>
                        <div class="mdl-typography--title" style="color:white">Date Of Birth</div>
                        <br>
                        </div><br><br>
                        <div class="mdl-textfield mdl-js-textfield">
                        <input class="mdl-textfield__input" type="text" id="DOB" onchange="checkDate()" name="DOB" required><br>
                        <label class="mdl-textfield__label" for="DOB"style="color:#606B71">Date Of Birth</label>
                            </div>
                        <br>
                        <br>

                        <br><div class="mdl-shadow--16dp" style="background-color:#4F5356  ">
                        <br>
                        <div class="mdl-typography--title" style="color:white">Gender</div>
                        <br>
                        </div><br><br>
                        <br>
                        <div>
            ...
            <div class="mdl-shadow--16dp" style="background-color:#4F5356  ">
                        <br>
                        <div class="mdl-typography--title" style="color:white">Nationality</div>
                        <br>
                        </div><br><br>
                <div class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label">
                ...
                <center>
                    <br><div class="mdl-shadow--16dp" style="background-color:#4F5356 ">
                        <br>
                        <div class="mdl-typography--title" style="color:white">Occupation</div>
                        <br><br>
                        </div><br>
            ...
            <br><br>
                ...
                <b> <div class="mdl-shadow--16dp" style="background-color:#4F5356 ">
                        <br>
                        <div class="mdl-typography--title" style="color:white">Address</div>
                        <br>
                        </div></b><br><br><br>
                <div class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label">
            ...
            <br><br>
                ...
                <b> <br><div class="mdl-shadow--16dp" style="background-color:#4F5356 ">
                        <br>
                        <div class="mdl-typography--title" style="color:white">Mobile No</div>
                        <br>
                        </div></b><br>
                <div class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label">
                    <input class="mdl-textfield__input" type="text" id="Mobile-No" name="Mobile-No">
                    <label class="mdl-textfield__label" for="Mobile-No"style="color:#606B71">Mobile No</label>
                </div>
                <b> <br><div class="mdl-shadow--16dp" style="background-color:#4F5356  ">
                        <br>
                        <div class="mdl-typography--title" style="color:white">Password</div>
                        <br>
                        </div> </b><br>
                <div class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label">
                    <input class="mdl-textfield__input" type="password" id="Password" name="Password">
                    <label class="mdl-textfield__label" for="Password"style="color:#606B71">Password</label>
                </div>
                <b> <br><div class="mdl-shadow--16dp" style="background-color:#4F5356 ">
                        <br>
                        <div class="mdl-typography--title" style="color:white">Re enter your Password</div>
                        <br>
                        </div></b><br>
                <div class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label">
                ...
                <div class="mdl-shadow--16dp" style="background-color:#EDF3F7"><br>
