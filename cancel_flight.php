...
<input style="background-color:#4F5356;color:white;"type="Submit" name="cancel" value="Cancel the selected Flight" class="mdl-button mdl-js-button mdl-button--raised mdl-js-ripple-effect mdl-button--accent">
